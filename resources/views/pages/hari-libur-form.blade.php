<x-modal title="Form Hari Libur" action="{{ $action }}">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            {{-- <p>hai</p> --}}
            <x-forms.datepicker-range label="Tanggal libur" date_name1="tanggal_awal" date_name2="tanggal_akhir" date_value1="{{ $data->tanggal_awal }}" date_value2="{{ $data->tanggal_akhir }}" />
